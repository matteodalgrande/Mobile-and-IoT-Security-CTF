...
public abstract class FragmentTransaction {
    ...
    int mExitAnim;
    String mName;
    ArrayList<C0320Op> mOps = new ArrayList<>();
    int mPopEnterAnim;
    int mPopExitAnim;
    ...
    static final class C0320Op {
        ...
        C0320Op(int cmd, Fragment fragment) {
            this.mCmd = cmd;
        ...
        C0320Op(int cmd, Fragment fragment, Lifecycle.State state) {
            this.mCmd = cmd;
            this.mFragment = fragment;
    ...
    public void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
        ...
        addOp(new C0320Op(opcmd, fragment));
    }
