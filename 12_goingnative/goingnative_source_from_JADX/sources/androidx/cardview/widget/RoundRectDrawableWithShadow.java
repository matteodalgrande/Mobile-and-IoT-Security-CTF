...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C0015R.C0016color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0015R.C0016color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0015R.dimen.cardview_compat_inset_shadow);
