...
import androidx.recyclerview.C0063R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C0063R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C0063R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0063R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C0063R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C0063R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C0063R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C0063R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C0063R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0063R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0063R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0063R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C03931 r0 = new ViewBoundsCheck.Callback() {
            ...
            C03942 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int index) {
                    return LayoutManager.this.getChildAt(index);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0063R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0063R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0063R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0063R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0063R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0063R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0063R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0063R.dimen.fastscroll_margin));
    }
