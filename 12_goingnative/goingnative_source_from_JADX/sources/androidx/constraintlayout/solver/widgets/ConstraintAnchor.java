...
public class ConstraintAnchor {
    ...
    public boolean isValidConnection(ConstraintAnchor anchor) {
        ...
        if (target != type) {
            switch (C02131.f76x4c44d048[this.mType.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C02131 {
        ...
        static {
            ...
            try {
                f76x4c44d048[Type.LEFT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f76x4c44d048[Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f76x4c44d048[Type.TOP.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f76x4c44d048[Type.BOTTOM.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f76x4c44d048[Type.BASELINE.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f76x4c44d048[Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f76x4c44d048[Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f76x4c44d048[Type.NONE.ordinal()] = 9;
