...
public abstract class WidgetRun implements Dependency {
    ...
    public final DependencyNode getTarget(ConstraintAnchor anchor) {
        ...
        int i = C02181.f87x4c44d048[anchor.mTarget.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C02181 {
        ...
        static final /* synthetic */ int[] f87x4c44d048;
        ...
        static {
            ...
            try {
                f87x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f87x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f87x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f87x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
