    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        if (i3 >= 0 && i3 < 4) {
            ...
            if (this.resolved) {
                ...
                if (i4 == 0 || i4 == 1) {
                    linearSystem.addEquality(this.mLeft.mSolverVariable, this.f77mX);
                    linearSystem.addEquality(this.mRight.mSolverVariable, this.f77mX);
                } else if (i4 == 2 || i4 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f78mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f78mY);
                }
            } else {
