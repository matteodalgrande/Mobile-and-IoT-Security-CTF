...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C02081 {
        ...
        static final /* synthetic */ int[] f74x7d4bfe12;
        ...
        static {
            ...
            try {
                f74x7d4bfe12[State.Constraint.LEFT_TO_RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f74x7d4bfe12[State.Constraint.RIGHT_TO_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f74x7d4bfe12[State.Constraint.RIGHT_TO_RIGHT.ordinal()] = 4;
            } catch (NoSuchFieldError e4) {
            }
            try {
                f74x7d4bfe12[State.Constraint.START_TO_START.ordinal()] = 5;
            } catch (NoSuchFieldError e5) {
            }
            try {
                f74x7d4bfe12[State.Constraint.START_TO_END.ordinal()] = 6;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f74x7d4bfe12[State.Constraint.END_TO_START.ordinal()] = 7;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f74x7d4bfe12[State.Constraint.END_TO_END.ordinal()] = 8;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f74x7d4bfe12[State.Constraint.TOP_TO_TOP.ordinal()] = 9;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f74x7d4bfe12[State.Constraint.TOP_TO_BOTTOM.ordinal()] = 10;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f74x7d4bfe12[State.Constraint.BOTTOM_TO_TOP.ordinal()] = 11;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f74x7d4bfe12[State.Constraint.BOTTOM_TO_BOTTOM.ordinal()] = 12;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f74x7d4bfe12[State.Constraint.BASELINE_TO_BASELINE.ordinal()] = 13;
            } catch (NoSuchFieldError e13) {
            }
            try {
                f74x7d4bfe12[State.Constraint.CENTER_HORIZONTALLY.ordinal()] = 14;
            } catch (NoSuchFieldError e14) {
            }
            try {
                f74x7d4bfe12[State.Constraint.CENTER_VERTICALLY.ordinal()] = 15;
    ...
    public ConstraintReference margin(int value) {
        if (this.mLast != null) {
            switch (C02081.f74x7d4bfe12[this.mLast.ordinal()]) {
                case 1:
                case 2:
    ...
    private void applyConnection(ConstraintWidget widget, Object opaqueTarget, State.Constraint type) {
        ...
        if (target != null) {
            int i = C02081.f74x7d4bfe12[type.ordinal()];
            switch (C02081.f74x7d4bfe12[type.ordinal()]) {
                case 1:
