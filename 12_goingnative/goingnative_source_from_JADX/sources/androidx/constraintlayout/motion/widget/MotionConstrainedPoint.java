...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint points, boolean[] mask, String[] custom) {
        ...
        int c2 = c + 1;
        mask[c] = mask[c] | diff(this.f67x, points.f67x);
        int c3 = c2 + 1;
        mask[c2] = mask[c2] | diff(this.f68y, points.f68y);
        int c4 = c3 + 1;
    ...
    public void fillStandard(double[] data, int[] toUse) {
        float[] set = {this.position, this.f67x, this.f68y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int c = 0;
