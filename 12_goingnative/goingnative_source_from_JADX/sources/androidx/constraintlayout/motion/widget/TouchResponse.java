...
class TouchResponse {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C0017R.styleable.OnSwipe);
        fill(a);
        a.recycle();
    }
    ...
    private void fill(TypedArray a) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (attr == C0017R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = a.getResourceId(attr, this.mTouchAnchorId);
            } else if (attr == C0017R.styleable.OnSwipe_touchAnchorSide) {
