...
public class MotionController {
    ...
    public KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        start.left = this.mStartMotionPath.f71x;
        start.top = this.mStartMotionPath.f72y;
        start.right = start.left + this.mStartMotionPath.width;
        start.bottom = start.top + this.mStartMotionPath.height;
        RectF end = new RectF();
        end.left = this.mEndMotionPath.f71x;
        end.top = this.mEndMotionPath.f72y;
    ...
    public float getKeyFrameParameter(int type, float x, float y) {
        float dx = this.mEndMotionPath.f71x - this.mStartMotionPath.f71x;
        float dy = this.mEndMotionPath.f72y - this.mStartMotionPath.f72y;
        float startCenterX = this.mStartMotionPath.f71x + (this.mStartMotionPath.width / 2.0f);
        float startCenterY = this.mStartMotionPath.f72y + (this.mStartMotionPath.height / 2.0f);
    ...
    public boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float float_l = this.mStartMotionPath.f71x + ((this.mEndMotionPath.f71x - this.mStartMotionPath.f71x) * position);
            float float_t = this.mStartMotionPath.f72y + ((this.mEndMotionPath.f72y - this.mStartMotionPath.f72y) * position);
    ...
    public void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float dleft = this.mEndMotionPath.f71x - this.mStartMotionPath.f71x;
        float dTop = this.mEndMotionPath.f72y - this.mStartMotionPath.f72y;
