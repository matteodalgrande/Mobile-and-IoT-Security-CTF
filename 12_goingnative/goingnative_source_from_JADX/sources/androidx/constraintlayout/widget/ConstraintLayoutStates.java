...
public class ConstraintLayoutStates {
    ...
    private void load(android.content.Context r13, int r14) {
        /*
            ...
            r3 = 0
            r4 = 0
            int r5 = r1.getEventType()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
        L_0x000f:
            r6 = 1
        ...
        L_0x001c:
            ...
            goto L_0x00a8
        L_0x001f:
            java.lang.String r9 = r1.getName()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r3 = r9
            r9 = -1
            int r10 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r11 = 4
            switch(r10) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
        L_0x002d:
            goto L_0x005f
        L_0x002e:
            java.lang.String r10 = "Variant"
            boolean r10 = r3.equals(r10)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
        ...
        L_0x005f:
            ...
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r7.<init>()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            java.lang.String r8 = "unknown tag "
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            java.lang.StringBuilder r7 = r7.append(r3)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            java.lang.String r7 = r7.toString()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            android.util.Log.v(r6, r7)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            goto L_0x00a1
        L_0x0082:
            r12.parseConstraintSet(r13, r1)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            goto L_0x00a1
        L_0x0086:
            androidx.constraintlayout.widget.ConstraintLayoutStates$Variant r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$Variant     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r6.<init>(r13, r1)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            if (r4 == 0) goto L_0x00a1
            r4.add(r6)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            goto L_0x00a1
        L_0x0091:
            androidx.constraintlayout.widget.ConstraintLayoutStates$State r6 = new androidx.constraintlayout.widget.ConstraintLayoutStates$State     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r6.<init>(r13, r1)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r4 = r6
            android.util.SparseArray<androidx.constraintlayout.widget.ConstraintLayoutStates$State> r6 = r12.mStateList     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            int r7 = r4.mId     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r6.put(r7, r4)     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            goto L_0x00a1
        L_0x009f:
            goto L_0x00a1
        L_0x00a0:
        L_0x00a1:
            goto L_0x00a8
        L_0x00a2:
            java.lang.String r6 = r1.getName()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r2 = r6
        L_0x00a8:
            int r6 = r1.next()     // Catch:{ XmlPullParserException -> 0x00b5, IOException -> 0x00b0 }
            r5 = r6
            goto L_0x000f
        L_0x00af:
            goto L_0x00b9
