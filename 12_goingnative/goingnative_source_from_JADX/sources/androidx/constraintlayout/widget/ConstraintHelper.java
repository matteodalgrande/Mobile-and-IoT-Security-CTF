...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (attr == C0017R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = a.getString(attr);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (attr == C0017R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    private int findId(java.lang.String r6) {
        ...
        L_0x0031:
            ...
            java.lang.Class<androidx.constraintlayout.widget.R$id> r2 = androidx.constraintlayout.widget.C0017R.C0020id.class
