...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) {
            ...
            int maxWidth = res.getDimensionPixelSize(C0026R.dimen.compat_notification_large_icon_max_width);
            int maxHeight = res.getDimensionPixelSize(C0026R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) {
            ...
            L_0x0028:
                ...
                int r9 = androidx.core.C0026R.C0029id.notification_background
                int r10 = androidx.core.C0026R.C0028drawable.notification_bg_low
                r2.setInt(r9, r6, r10)
                int r9 = androidx.core.C0026R.C0029id.icon
                int r10 = androidx.core.C0026R.C0028drawable.notification_template_icon_low_bg
                r2.setInt(r9, r6, r10)
                goto L_0x0056
            L_0x0048:
                int r9 = androidx.core.C0026R.C0029id.notification_background
                int r10 = androidx.core.C0026R.C0028drawable.notification_bg
                r2.setInt(r9, r6, r10)
                int r9 = androidx.core.C0026R.C0029id.icon
                int r10 = androidx.core.C0026R.C0028drawable.notification_template_icon_bg
                r2.setInt(r9, r6, r10)
            L_0x0056:
                androidx.core.app.NotificationCompat$Builder r6 = r0.mBuilder
                ...
                int r6 = androidx.core.C0026R.C0029id.icon
            ...
            L_0x0076:
                ...
                int r6 = androidx.core.C0026R.dimen.notification_right_icon_size
                int r6 = r1.getDimensionPixelSize(r6)
                int r9 = androidx.core.C0026R.dimen.notification_small_icon_background_padding
                ...
                int r10 = androidx.core.C0026R.C0029id.right_icon
            ...
            L_0x00aa:
                ...
                r2.setImageViewBitmap(r10, r7)
            L_0x00b9:
                int r7 = androidx.core.C0026R.C0029id.right_icon
            ...
            L_0x00bf:
                ...
                int r6 = androidx.core.C0026R.dimen.notification_large_icon_width
                int r6 = r1.getDimensionPixelSize(r6)
                int r7 = androidx.core.C0026R.dimen.notification_big_circle_margin
                int r7 = r1.getDimensionPixelSize(r7)
                int r6 = r6 - r7
                int r7 = androidx.core.C0026R.dimen.notification_small_icon_size_as_large
                int r7 = r1.getDimensionPixelSize(r7)
                androidx.core.app.NotificationCompat$Builder r9 = r0.mBuilder
                ...
                int r10 = androidx.core.C0026R.C0029id.icon
            ...
            L_0x010a:
                ...
                int r6 = androidx.core.C0026R.C0029id.title
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x0119:
                ...
                int r6 = androidx.core.C0026R.C0029id.text
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
            ...
            L_0x0136:
                ...
                int r7 = androidx.core.C0026R.C0029id.info
            ...
            L_0x014e:
                ...
                int r7 = androidx.core.C0026R.integer.status_bar_notification_info_maxnum
                int r7 = r1.getInteger(r7)
                androidx.core.app.NotificationCompat$Builder r8 = r0.mBuilder
                int r8 = r8.mNumber
                if (r8 <= r7) goto L_0x016c
                int r8 = androidx.core.C0026R.C0029id.info
                int r9 = androidx.core.C0026R.string.status_bar_notification_info_overflow
                java.lang.String r9 = r1.getString(r9)
                r2.setTextViewText(r8, r9)
                goto L_0x017e
            L_0x016c:
                java.text.NumberFormat r8 = java.text.NumberFormat.getIntegerInstance()
                int r9 = androidx.core.C0026R.C0029id.info
                androidx.core.app.NotificationCompat$Builder r10 = r0.mBuilder
                int r10 = r10.mNumber
                long r10 = (long) r10
            ...
            L_0x018d:
                ...
                int r6 = androidx.core.C0026R.C0029id.text2
                androidx.core.app.NotificationCompat$Builder r7 = r0.mBuilder
                java.lang.CharSequence r7 = r7.mContentText
                r2.setTextViewText(r6, r7)
                int r6 = androidx.core.C0026R.C0029id.text2
            ...
            L_0x01bf:
                ...
                int r5 = androidx.core.C0026R.dimen.notification_subtext_size
                int r5 = r1.getDimensionPixelSize(r5)
                float r5 = (float) r5
                int r6 = androidx.core.C0026R.C0029id.text
                r2.setTextViewTextSize(r6, r12, r5)
            L_0x01d3:
                int r6 = androidx.core.C0026R.C0029id.line1
                r7 = 0
                r8 = 0
                r9 = 0
                r10 = 0
            ...
            L_0x01dd:
                ...
                int r5 = androidx.core.C0026R.C0029id.chronometer
                ...
                goto L_0x0240
            L_0x022e:
                int r5 = androidx.core.C0026R.C0029id.time
                r2.setViewVisibility(r5, r12)
                int r5 = androidx.core.C0026R.C0029id.time
                androidx.core.app.NotificationCompat$Builder r6 = r0.mBuilder
                long r6 = r6.getWhenIfShowing()
            ...
            L_0x0240:
                r11 = 1
            L_0x0241:
                int r5 = androidx.core.C0026R.C0029id.right_side
            ...
            L_0x0248:
                ...
                int r5 = androidx.core.C0026R.C0029id.line3
        ...
        private Bitmap createIconWithBackground(int iconId, int size, int iconSize, int color) {
            Bitmap coloredBitmap = createColoredBitmap(C0026R.C0028drawable.notification_icon_background, color == 0 ? 0 : color, size);
        ...
        public void buildIntoRemoteViews(RemoteViews outerView, RemoteViews innerView) {
            ...
            outerView.removeAllViews(C0026R.C0029id.notification_main_column);
            outerView.addView(C0026R.C0029id.notification_main_column, innerView.clone());
            outerView.setViewVisibility(C0026R.C0029id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                outerView.setViewPadding(C0026R.C0029id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }

        private void hideNormalContent(RemoteViews outerView) {
            outerView.setViewVisibility(C0026R.C0029id.title, 8);
            outerView.setViewVisibility(C0026R.C0029id.text2, 8);
            outerView.setViewVisibility(C0026R.C0029id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int padding = resources.getDimensionPixelSize(C0026R.dimen.notification_top_pad);
            int largePadding = resources.getDimensionPixelSize(C0026R.dimen.notification_top_pad_large_text);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            RemoteViews remoteViews = applyStandardTemplate(true, C0026R.layout.notification_template_custom_big, false);
            remoteViews.removeAllViews(C0026R.C0029id.actions);
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    remoteViews.addView(C0026R.C0029id.actions, generateActionButton(nonContextualActions.get(i)));
                }
            }
            if (!actionsVisible) {
                actionVisibility = 8;
            }
            remoteViews.setViewVisibility(C0026R.C0029id.actions, actionVisibility);
            remoteViews.setViewVisibility(C0026R.C0029id.action_divider, actionVisibility);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (tombstone) {
                i = C0026R.layout.notification_action_tombstone;
            } else {
                i = C0026R.layout.notification_action;
            }
            RemoteViews button = new RemoteViews(packageName, i);
            button.setImageViewBitmap(C0026R.C0029id.action_image, createColoredBitmap(action.getIconCompat(), this.mBuilder.mContext.getResources().getColor(C0026R.C0027color.notification_action_color_filter)));
            button.setTextViewText(C0026R.C0029id.action_text, action.title);
            if (!tombstone) {
                button.setOnClickPendingIntent(C0026R.C0029id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0026R.C0029id.action_container, action.title);
            }
            return button;
        }
    }
