...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0026R.C0029id.accessibility_custom_action_0, C0026R.C0029id.accessibility_custom_action_1, C0026R.C0029id.accessibility_custom_action_2, C0026R.C0029id.accessibility_custom_action_3, C0026R.C0029id.accessibility_custom_action_4, C0026R.C0029id.accessibility_custom_action_5, C0026R.C0029id.accessibility_custom_action_6, C0026R.C0029id.accessibility_custom_action_7, C0026R.C0029id.accessibility_custom_action_8, C0026R.C0029id.accessibility_custom_action_9, C0026R.C0029id.accessibility_custom_action_10, C0026R.C0029id.accessibility_custom_action_11, C0026R.C0029id.accessibility_custom_action_12, C0026R.C0029id.accessibility_custom_action_13, C0026R.C0029id.accessibility_custom_action_14, C0026R.C0029id.accessibility_custom_action_15, C0026R.C0029id.accessibility_custom_action_16, C0026R.C0029id.accessibility_custom_action_17, C0026R.C0029id.accessibility_custom_action_18, C0026R.C0029id.accessibility_custom_action_19, C0026R.C0029id.accessibility_custom_action_20, C0026R.C0029id.accessibility_custom_action_21, C0026R.C0029id.accessibility_custom_action_22, C0026R.C0029id.accessibility_custom_action_23, C0026R.C0029id.accessibility_custom_action_24, C0026R.C0029id.accessibility_custom_action_25, C0026R.C0029id.accessibility_custom_action_26, C0026R.C0029id.accessibility_custom_action_27, C0026R.C0029id.accessibility_custom_action_28, C0026R.C0029id.accessibility_custom_action_29, C0026R.C0029id.accessibility_custom_action_30, C0026R.C0029id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (ArrayList) view.getTag(C0026R.C0029id.tag_accessibility_actions);
        if (actions != null) {
            return actions;
        }
        ArrayList<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions2 = new ArrayList<>();
        view.setTag(C0026R.C0029id.tag_accessibility_actions, actions2);
        return actions2;
    }
    ...
    public static void addOnUnhandledKeyEventListener(View v, final OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            SimpleArrayMap<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (SimpleArrayMap) v.getTag(C0026R.C0029id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                viewListeners = new SimpleArrayMap<>();
                v.setTag(C0026R.C0029id.tag_unhandled_key_listeners, viewListeners);
            }
        ...
        ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners2 = (ArrayList) v.getTag(C0026R.C0029id.tag_unhandled_key_listeners);
        if (viewListeners2 == null) {
            viewListeners2 = new ArrayList<>();
            v.setTag(C0026R.C0029id.tag_unhandled_key_listeners, viewListeners2);
        }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0026R.C0029id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0026R.C0029id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0026R.C0029id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            public Boolean frameworkGet(View view) {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m6at(View root) {
            UnhandledKeyEventManager manager = (UnhandledKeyEventManager) root.getTag(C0026R.C0029id.tag_unhandled_key_event_manager);
            if (manager != null) {
                return manager;
            }
            UnhandledKeyEventManager manager2 = new UnhandledKeyEventManager();
            root.setTag(C0026R.C0029id.tag_unhandled_key_event_manager, manager2);
            return manager2;
        }
        ...
        private boolean onUnhandledKeyEvent(View v, KeyEvent event) {
            ArrayList<OnUnhandledKeyEventListenerCompat> viewListeners = (ArrayList) v.getTag(C0026R.C0029id.tag_unhandled_key_listeners);
            if (viewListeners == null) {
                return false;
            }
