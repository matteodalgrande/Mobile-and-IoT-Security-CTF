...
public class AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View host, int action, Bundle args) {
        ...
        if (success || action != C0026R.C0029id.accessibility_action_clickable_span) {
            return success;
        }
    ...
    private boolean performClickableSpanAction(int clickableSpanId, View host) {
        ...
        SparseArray<WeakReference<ClickableSpan>> spans = (SparseArray) host.getTag(C0026R.C0029id.tag_accessibility_clickable_spans);
    ...
    static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actions = (List) view.getTag(C0026R.C0029id.tag_accessibility_actions);
