...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0005R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes((AttributeSet) null, C0005R.styleable.AlertDialog, C0005R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0005R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0005R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0005R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0005R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0005R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0005R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0005R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = a.getDimensionPixelSize(C0005R.styleable.AlertDialog_buttonIconDimen, 0);
        a.recycle();
    ...
    private void setupView() {
        ...
        View parentPanel = this.mWindow.findViewById(C0005R.C0008id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0005R.C0008id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0005R.C0008id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0005R.C0008id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0005R.C0008id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0005R.C0008id.topPanel);
        View customContentPanel = customPanel.findViewById(C0005R.C0008id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0005R.C0008id.buttonPanel);
        ...
        if (hasButtonPanel) {
            ...
            View spacer = contentPanel.findViewById(C0005R.C0008id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                divider = topPanel.findViewById(C0005R.C0008id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0005R.C0008id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0005R.C0008id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0005R.C0008id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0005R.C0008id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0005R.C0008id.title_template).setVisibility(8);
            return;
        }
        ...
        TextView textView = (TextView) this.mWindow.findViewById(C0005R.C0008id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0005R.C0008id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0005R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0005R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0005R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
