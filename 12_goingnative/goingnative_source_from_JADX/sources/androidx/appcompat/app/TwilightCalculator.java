...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (f53J0 + ((float) Math.round(((double) (daysSince2000 - f53J0)) - arcLongitude)))) + arcLongitude + (Math.sin((double) meanAnomaly) * 0.0053d) + (Math.sin(2.0d * solarLng) * -0.0069d);
