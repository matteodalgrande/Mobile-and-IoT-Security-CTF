...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public Context attachBaseContext2(Context baseContext) {
        ...
        try {
            ...
            androidx.appcompat.view.ContextThemeWrapper wrappedContext = new androidx.appcompat.view.ContextThemeWrapper(baseContext, C0005R.style.Theme_AppCompat_Empty);
    ...
    private android.view.ViewGroup createSubDecor() {
        /*
            ...
            int[] r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme
            android.content.res.TypedArray r0 = r0.obtainStyledAttributes(r1)
            int r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme_windowActionBar
            boolean r1 = r0.hasValue(r1)
            if (r1 == 0) goto L_0x01b5
            int r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme_windowNoTitle
            r2 = 0
        ...
        L_0x002b:
            int r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme_windowActionBarOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            r4 = 109(0x6d, float:1.53E-43)
            if (r1 == 0) goto L_0x0038
            r10.requestWindowFeature(r4)
        L_0x0038:
            int r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme_windowActionModeOverlay
            boolean r1 = r0.getBoolean(r1, r2)
            if (r1 == 0) goto L_0x0045
            r1 = 10
            r10.requestWindowFeature(r1)
        L_0x0045:
            int r1 = androidx.appcompat.C0005R.styleable.AppCompatTheme_android_windowIsFloating
            boolean r1 = r0.getBoolean(r1, r2)
            r10.mIsFloating = r1
            r0.recycle()
            r10.ensureWindow()
            ...
            int r3 = androidx.appcompat.C0005R.layout.abc_dialog_title_material
        ...
        L_0x0077:
            ...
            int r9 = androidx.appcompat.C0005R.attr.actionBarTheme
        ...
        L_0x009b:
            ...
            int r9 = androidx.appcompat.C0005R.layout.abc_screen_toolbar
            android.view.View r8 = r8.inflate(r9, r7)
            r5 = r8
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            int r8 = androidx.appcompat.C0005R.C0008id.decor_content_parent
        ...
        L_0x00d7:
            ...
            int r3 = androidx.appcompat.C0005R.layout.abc_screen_simple_overlay_action_mode
            android.view.View r3 = r1.inflate(r3, r7)
            r5 = r3
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
            goto L_0x00ee
        L_0x00e5:
            int r3 = androidx.appcompat.C0005R.layout.abc_screen_simple
            android.view.View r3 = r1.inflate(r3, r7)
            r5 = r3
            android.view.ViewGroup r5 = (android.view.ViewGroup) r5
        L_0x00ee:
        ...
        L_0x010e:
            ...
            int r3 = androidx.appcompat.C0005R.C0008id.title
            android.view.View r3 = r5.findViewById(r3)
            android.widget.TextView r3 = (android.widget.TextView) r3
            r10.mTitleView = r3
        L_0x011c:
            androidx.appcompat.widget.ViewUtils.makeOptionalFitsSystemWindows(r5)
            int r3 = androidx.appcompat.C0005R.C0008id.action_bar_activity_content
            android.view.View r3 = r5.findViewById(r3)
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0005R.styleable.AppCompatTheme);
        a.getValue(C0005R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0005R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0005R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0005R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0005R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0005R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0005R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0005R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0005R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0005R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0005R.attr.actionBarTheme, outValue, true);
                    ...
                    PopupWindow popupWindow = new PopupWindow(actionBarContext, (AttributeSet) null, C0005R.attr.actionModePopupWindowStyle);
                    this.mActionModePopup = popupWindow;
                    PopupWindowCompat.setWindowLayoutType(popupWindow, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0005R.attr.actionBarSize, outValue, true);
                    ...
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0005R.C0008id.action_mode_bar_stub);
                    if (stub != null) {
    ...
    public View createView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String viewInflaterClassName = this.mContext.obtainStyledAttributes(C0005R.styleable.AppCompatTheme).getString(C0005R.styleable.AppCompatTheme_viewInflaterClass);
        ...
        if (!panelFeatureState.isOpen && !this.mIsDestroyed) {
            ...
            if (cb == null || cb.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(width, -2, panelFeatureState.f48x, panelFeatureState.f49y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        ...
        if ((st.featureId == 0 || st.featureId == 108) && this.mDecorContentParent != null) {
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(C0005R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0005R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private void updateStatusGuardColor(View v) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(v) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0005R.C0006color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0005R.C0006color.abc_decor_view_status_guard);
        }
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0005R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0005R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0005R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0005R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0005R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0005R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0005R.layout.abc_list_menu_item_layout);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0005R.attr.homeAsUpIndicator});
