...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0005R.styleable.ActivityChooserView, defStyle, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0005R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0005R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0005R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0005R.layout.abc_activity_chooser_view, this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        View findViewById = findViewById(C0005R.C0008id.activity_chooser_view_content);
        this.mActivityChooserContent = findViewById;
        this.mActivityChooserContentBackground = findViewById.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C0005R.C0008id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0005R.C0008id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0005R.C0008id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C0005R.C0008id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0005R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(getContext().getString(C0005R.string.abc_activitychooserview_choose_application));
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            int itemViewType = getItemViewType(position);
            if (itemViewType == 0) {
                if (convertView == null || convertView.getId() != C0005R.C0008id.list_item) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0005R.layout.abc_activity_chooser_view_list_item, parent, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo activity = (ResolveInfo) getItem(position);
                ((ImageView) convertView.findViewById(C0005R.C0008id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                ((TextView) convertView.findViewById(C0005R.C0008id.title)).setText(activity.loadLabel(packageManager));
                ...
                View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0005R.layout.abc_activity_chooser_view_list_item, parent, false);
                convertView2.setId(1);
                ((TextView) convertView2.findViewById(C0005R.C0008id.title)).setText(ActivityChooserView.this.getContext().getString(C0005R.string.abc_activity_chooser_view_see_all));
                return convertView2;
            }
        }
