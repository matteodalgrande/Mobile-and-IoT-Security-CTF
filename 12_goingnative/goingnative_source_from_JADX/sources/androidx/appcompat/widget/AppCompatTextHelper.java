...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0005R.styleable.AppCompatTextHelper, i, 0);
        TextView textView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0005R.styleable.AppCompatTextHelper, attrs, a.getWrappedTypeArray(), defStyleAttr, 0);
        int ap = a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (Build.VERSION.SDK_INT >= 17) {
            if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableStart)) {
                this.mDrawableStartTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableStart, 0));
            }
            if (a.hasValue(C0005R.styleable.AppCompatTextHelper_android_drawableEnd)) {
                this.mDrawableEndTint = createTintInfo(context, drawableManager3, a.getResourceId(C0005R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
            }
        }
        a.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0005R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0005R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0005R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (Build.VERSION.SDK_INT < 23) {
                if (a2.hasValue(C0005R.styleable.TextAppearance_android_textColor)) {
                    textColor2 = a2.getColorStateList(C0005R.styleable.TextAppearance_android_textColor);
                }
                if (a2.hasValue(C0005R.styleable.TextAppearance_android_textColorHint)) {
                    textColorHint = a2.getColorStateList(C0005R.styleable.TextAppearance_android_textColorHint);
                }
                if (a2.hasValue(C0005R.styleable.TextAppearance_android_textColorLink)) {
                    textColorLink2 = a2.getColorStateList(C0005R.styleable.TextAppearance_android_textColorLink);
                }
            }
            if (a2.hasValue(C0005R.styleable.TextAppearance_textLocale)) {
                localeListString3 = a2.getString(C0005R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0005R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation2 = a2.getString(C0005R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0005R.styleable.TextAppearance, i, 0);
        if (hasPwdTm || !a3.hasValue(C0005R.styleable.TextAppearance_textAllCaps)) {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        } else {
            allCaps = a3.getBoolean(C0005R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        }
        if (Build.VERSION.SDK_INT < 23) {
            if (a3.hasValue(C0005R.styleable.TextAppearance_android_textColor)) {
                textColor2 = a3.getColorStateList(C0005R.styleable.TextAppearance_android_textColor);
            }
            if (a3.hasValue(C0005R.styleable.TextAppearance_android_textColorHint)) {
                textColorHint = a3.getColorStateList(C0005R.styleable.TextAppearance_android_textColorHint);
            }
            if (a3.hasValue(C0005R.styleable.TextAppearance_android_textColorLink)) {
                textColorLink = textColor2;
                textColor = a3.getColorStateList(C0005R.styleable.TextAppearance_android_textColorLink);
            } else {
        ...
        if (a3.hasValue(C0005R.styleable.TextAppearance_textLocale)) {
            localeListString = a3.getString(C0005R.styleable.TextAppearance_textLocale);
        } else {
            localeListString = localeListString3;
        }
        String fontVariation3 = fontVariation2;
        if (Build.VERSION.SDK_INT < 26 || !a3.hasValue(C0005R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = fontVariation3;
        } else {
            fontVariation = a3.getString(C0005R.styleable.TextAppearance_fontVariationSettings);
        }
        int i2 = ap;
        if (Build.VERSION.SDK_INT < 28) {
            drawableManager = drawableManager3;
        } else if (!a3.hasValue(C0005R.styleable.TextAppearance_android_textSize)) {
            drawableManager = drawableManager3;
        } else if (a3.getDimensionPixelSize(C0005R.styleable.TextAppearance_android_textSize, -1) == 0) {
            drawableManager = drawableManager3;
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0005R.styleable.AppCompatTextView);
        Drawable drawableStart = null;
        Drawable drawableEnd = null;
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
        ...
        int drawableTopId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager2.getDrawable(context, drawableTopId);
        }
        int i4 = drawableTopId;
        int drawableRightId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableRightCompat, -1);
        if (drawableRightId != -1) {
            drawableRight = drawableManager2.getDrawable(context, drawableRightId);
        }
        int i5 = drawableRightId;
        int drawableBottomId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        if (drawableBottomId != -1) {
            drawableBottom = drawableManager2.getDrawable(context, drawableBottomId);
        } else {
            drawableBottom = null;
        }
        int drawableStartId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableStartCompat, -1);
        if (drawableStartId != -1) {
            drawableStart = drawableManager2.getDrawable(context, drawableStartId);
        }
        int i6 = drawableBottomId;
        int drawableEndId = a4.getResourceId(C0005R.styleable.AppCompatTextView_drawableEndCompat, -1);
        if (drawableEndId != -1) {
        ...
        if (a4.hasValue(C0005R.styleable.AppCompatTextView_drawableTint)) {
            TextViewCompat.setCompoundDrawableTintList(this.mView, a4.getColorStateList(C0005R.styleable.AppCompatTextView_drawableTint));
        }
        if (a4.hasValue(C0005R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a4.getInt(C0005R.styleable.AppCompatTextView_drawableTintMode, -1), (PorterDuff.Mode) null));
        }
        int firstBaselineToTopHeight = a4.getDimensionPixelSize(C0005R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a4.getDimensionPixelSize(C0005R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        int lineHeight = a4.getDimensionPixelSize(C0005R.styleable.AppCompatTextView_lineHeight, -1);
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = tintTypedArray.getInt(C0005R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = false;
        if (Build.VERSION.SDK_INT >= 28) {
            int i2 = tintTypedArray.getInt(C0005R.styleable.TextAppearance_android_textFontWeight, -1);
            this.mFontWeight = i2;
            if (i2 != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        if (tintTypedArray.hasValue(C0005R.styleable.TextAppearance_android_fontFamily) || tintTypedArray.hasValue(C0005R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            if (tintTypedArray.hasValue(C0005R.styleable.TextAppearance_fontFamily)) {
                i = C0005R.styleable.TextAppearance_fontFamily;
            } else {
                i = C0005R.styleable.TextAppearance_android_fontFamily;
            }
            int fontFamilyId = i;
        ...
        } else if (tintTypedArray.hasValue(C0005R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = tintTypedArray.getInt(C0005R.styleable.TextAppearance_android_typeface, 1);
            if (typefaceIndex == 1) {
    ...
    public void onSetTextAppearance(Context context, int resId) {
        String fontVariation;
        ColorStateList textColor;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0005R.styleable.TextAppearance);
        if (a.hasValue(C0005R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0005R.styleable.TextAppearance_textAllCaps, false));
        }
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0005R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0005R.styleable.TextAppearance_android_textColor)) != null) {
            this.mView.setTextColor(textColor);
        }
        if (a.hasValue(C0005R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0005R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, a);
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0005R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0005R.styleable.TextAppearance_fontVariationSettings)) != null) {
            this.mView.setFontVariationSettings(fontVariation);
        }
        a.recycle();
        Typeface typeface = this.mFontTypeface;
