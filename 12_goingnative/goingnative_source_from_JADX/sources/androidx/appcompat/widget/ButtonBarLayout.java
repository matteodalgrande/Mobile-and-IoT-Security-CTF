...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, C0005R.styleable.ButtonBarLayout);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0005R.styleable.ButtonBarLayout, attrs, ta, 0, 0);
        this.mAllowStacking = ta.getBoolean(C0005R.styleable.ButtonBarLayout_allowStacking, true);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0005R.C0008id.spacer);
        if (spacer != null) {
