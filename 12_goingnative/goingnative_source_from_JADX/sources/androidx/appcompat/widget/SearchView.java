...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0005R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C01765 r1 = new View.OnClickListener() {
        ...
        C01787 r2 = new TextView.OnEditorActionListener() {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0005R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater inflater = LayoutInflater.from(context);
        inflater.inflate(a.getResourceId(C0005R.styleable.SearchView_layout, C0005R.layout.abc_search_view), this, true);
        SearchAutoComplete searchAutoComplete = (SearchAutoComplete) findViewById(C0005R.C0008id.search_src_text);
        this.mSearchSrcTextView = searchAutoComplete;
        searchAutoComplete.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0005R.C0008id.search_edit_frame);
        View findViewById = findViewById(C0005R.C0008id.search_plate);
        this.mSearchPlate = findViewById;
        View findViewById2 = findViewById(C0005R.C0008id.submit_area);
        this.mSubmitArea = findViewById2;
        ImageView imageView = (ImageView) findViewById(C0005R.C0008id.search_button);
        this.mSearchButton = imageView;
        ImageView imageView2 = (ImageView) findViewById(C0005R.C0008id.search_go_btn);
        this.mGoButton = imageView2;
        ImageView imageView3 = (ImageView) findViewById(C0005R.C0008id.search_close_btn);
        this.mCloseButton = imageView3;
        ImageView imageView4 = (ImageView) findViewById(C0005R.C0008id.search_voice_btn);
        this.mVoiceButton = imageView4;
        ImageView imageView5 = (ImageView) findViewById(C0005R.C0008id.search_mag_icon);
        this.mCollapsedIcon = imageView5;
        LayoutInflater layoutInflater = inflater;
        ViewCompat.setBackground(findViewById, a.getDrawable(C0005R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(findViewById2, a.getDrawable(C0005R.styleable.SearchView_submitBackground));
        imageView.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_searchIcon));
        imageView2.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_goIcon));
        imageView3.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(a.getDrawable(C0005R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0005R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(imageView, getResources().getString(C0005R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0005R.styleable.SearchView_suggestionRowLayout, C0005R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0005R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(a.getBoolean(C0005R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0005R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0005R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0005R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0005R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0005R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0005R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0005R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0005R.dimen.abc_search_view_preferred_height);
    }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                iconOffset = res.getDimensionPixelSize(C0005R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0005R.dimen.abc_dropdownitem_text_padding_left);
            } else {
                iconOffset = 0;
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0005R.attr.autoCompleteTextViewStyle);
        }
