...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), (AttributeSet) null, C0005R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), (AttributeSet) null, C0005R.attr.actionDropDownStyle);
    ...
    private class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean forList) {
            super(context, (AttributeSet) null, C0005R.attr.actionBarTabStyle);
            int[] iArr = {16842964};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, iArr, C0005R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView2 = new AppCompatTextView(getContext(), (AttributeSet) null, C0005R.attr.actionBarTabTextStyle);
