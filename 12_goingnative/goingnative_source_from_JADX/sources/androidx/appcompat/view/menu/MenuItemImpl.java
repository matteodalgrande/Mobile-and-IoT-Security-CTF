...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(res.getString(C0005R.string.abc_prepend_shortcut_label));
        }
        int modifiers = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, modifiers, 65536, res.getString(C0005R.string.abc_menu_meta_shortcut_label));
        appendModifier(sb, modifiers, 4096, res.getString(C0005R.string.abc_menu_ctrl_shortcut_label));
        appendModifier(sb, modifiers, 2, res.getString(C0005R.string.abc_menu_alt_shortcut_label));
        appendModifier(sb, modifiers, 1, res.getString(C0005R.string.abc_menu_shift_shortcut_label));
        appendModifier(sb, modifiers, 4, res.getString(C0005R.string.abc_menu_sym_shortcut_label));
        appendModifier(sb, modifiers, 8, res.getString(C0005R.string.abc_menu_function_shortcut_label));
        if (shortcut == 8) {
            sb.append(res.getString(C0005R.string.abc_menu_delete_shortcut_label));
        } else if (shortcut == 10) {
            sb.append(res.getString(C0005R.string.abc_menu_enter_shortcut_label));
        } else if (shortcut != ' ') {
            sb.append(shortcut);
        } else {
            sb.append(res.getString(C0005R.string.abc_menu_space_shortcut_label));
        }
        return sb.toString();
    }
