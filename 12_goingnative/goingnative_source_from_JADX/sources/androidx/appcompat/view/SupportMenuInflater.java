...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0005R.styleable.MenuGroup);
            this.groupId = a.getResourceId(C0005R.styleable.MenuGroup_android_id, 0);
            this.groupCategory = a.getInt(C0005R.styleable.MenuGroup_android_menuCategory, 0);
            this.groupOrder = a.getInt(C0005R.styleable.MenuGroup_android_orderInCategory, 0);
            this.groupCheckable = a.getInt(C0005R.styleable.MenuGroup_android_checkableBehavior, 0);
            this.groupVisible = a.getBoolean(C0005R.styleable.MenuGroup_android_visible, true);
            this.groupEnabled = a.getBoolean(C0005R.styleable.MenuGroup_android_enabled, true);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(SupportMenuInflater.this.mContext, attrs, C0005R.styleable.MenuItem);
            this.itemId = a.getResourceId(C0005R.styleable.MenuItem_android_id, 0);
            this.itemCategoryOrder = (-65536 & a.getInt(C0005R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (65535 & a.getInt(C0005R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
            this.itemTitle = a.getText(C0005R.styleable.MenuItem_android_title);
            this.itemTitleCondensed = a.getText(C0005R.styleable.MenuItem_android_titleCondensed);
            this.itemIconResId = a.getResourceId(C0005R.styleable.MenuItem_android_icon, 0);
            this.itemAlphabeticShortcut = getShortcut(a.getString(C0005R.styleable.MenuItem_android_alphabeticShortcut));
            this.itemAlphabeticModifiers = a.getInt(C0005R.styleable.MenuItem_alphabeticModifiers, 4096);
            this.itemNumericShortcut = getShortcut(a.getString(C0005R.styleable.MenuItem_android_numericShortcut));
            this.itemNumericModifiers = a.getInt(C0005R.styleable.MenuItem_numericModifiers, 4096);
            if (a.hasValue(C0005R.styleable.MenuItem_android_checkable)) {
                this.itemCheckable = a.getBoolean(C0005R.styleable.MenuItem_android_checkable, false) ? 1 : 0;
            } else {
                this.itemCheckable = this.groupCheckable;
            }
            this.itemChecked = a.getBoolean(C0005R.styleable.MenuItem_android_checked, false);
            this.itemVisible = a.getBoolean(C0005R.styleable.MenuItem_android_visible, this.groupVisible);
            this.itemEnabled = a.getBoolean(C0005R.styleable.MenuItem_android_enabled, this.groupEnabled);
            this.itemShowAsAction = a.getInt(C0005R.styleable.MenuItem_showAsAction, -1);
            this.itemListenerMethodName = a.getString(C0005R.styleable.MenuItem_android_onClick);
            this.itemActionViewLayout = a.getResourceId(C0005R.styleable.MenuItem_actionLayout, 0);
            this.itemActionViewClassName = a.getString(C0005R.styleable.MenuItem_actionViewClass);
            String string = a.getString(C0005R.styleable.MenuItem_actionProviderClass);
            ...
            this.itemContentDescription = a.getText(C0005R.styleable.MenuItem_contentDescription);
            this.itemTooltipText = a.getText(C0005R.styleable.MenuItem_tooltipText);
            if (a.hasValue(C0005R.styleable.MenuItem_iconTintMode)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(a.getInt(C0005R.styleable.MenuItem_iconTintMode, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            if (a.hasValue(C0005R.styleable.MenuItem_iconTint)) {
                this.itemIconTintList = a.getColorStateList(C0005R.styleable.MenuItem_iconTint);
            } else {
