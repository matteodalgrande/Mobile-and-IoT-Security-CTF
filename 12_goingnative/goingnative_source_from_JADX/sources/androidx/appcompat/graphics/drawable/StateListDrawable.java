...
class StateListDrawable extends DrawableContainer {
    ...
    public void inflate(Context context, Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attrs, C0010R.styleable.StateListDrawable);
        setVisible(a.getBoolean(C0010R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.mVariablePadding = a.getBoolean(C0010R.styleable.StateListDrawable_android_variablePadding, state.mVariablePadding);
        state.mConstantSize = a.getBoolean(C0010R.styleable.StateListDrawable_android_constantSize, state.mConstantSize);
        state.mEnterFadeDuration = a.getInt(C0010R.styleable.StateListDrawable_android_enterFadeDuration, state.mEnterFadeDuration);
        state.mExitFadeDuration = a.getInt(C0010R.styleable.StateListDrawable_android_exitFadeDuration, state.mExitFadeDuration);
        state.mDither = a.getBoolean(C0010R.styleable.StateListDrawable_android_dither, state.mDither);
    }
            ...
            if (next != i) {
                ...
                if (depth < innerDepth && type2 == 3) {
                    ...
                    if (depth2 > innerDepth) {
                        ...
                        TypedArray a = TypedArrayUtils.obtainAttributes(r, theme, attributeSet, C0010R.styleable.StateListDrawableItem);
                        Drawable dr = null;
                        int drawableId = a.getResourceId(C0010R.styleable.StateListDrawableItem_android_drawable, -1);
                        if (drawableId > 0) {
