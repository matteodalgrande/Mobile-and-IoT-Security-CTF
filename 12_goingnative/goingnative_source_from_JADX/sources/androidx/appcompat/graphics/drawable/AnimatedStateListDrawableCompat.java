...
import androidx.appcompat.resources.C0010R;
...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    public void inflate(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0010R.styleable.AnimatedStateListDrawableCompat);
        setVisible(a.getBoolean(C0010R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    private static class AnimatableTransition extends Transition {
        ...
        /* renamed from: mA */
        private final Animatable f54mA;
    ...
    private void updateStateFromTypedArray(TypedArray a) {
        ...
        state.setVariablePadding(a.getBoolean(C0010R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, state.mVariablePadding));
        state.setConstantSize(a.getBoolean(C0010R.styleable.AnimatedStateListDrawableCompat_android_constantSize, state.mConstantSize));
        state.setEnterFadeDuration(a.getInt(C0010R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, state.mEnterFadeDuration));
        state.setExitFadeDuration(a.getInt(C0010R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, state.mExitFadeDuration));
        setDither(a.getBoolean(C0010R.styleable.AnimatedStateListDrawableCompat_android_dither, state.mDither));
    }
    ...
    private int parseTransition(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme2, attrs, C0010R.styleable.AnimatedStateListDrawableTransition);
        int fromId = a.getResourceId(C0010R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int toId = a.getResourceId(C0010R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        Drawable dr = null;
        int drawableId = a.getResourceId(C0010R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        if (drawableId > 0) {
            dr = ResourceManagerInternal.get().getDrawable(context, drawableId);
        } else {
            Context context2 = context;
        }
        boolean reversible = a.getBoolean(C0010R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        a.recycle();
        if (dr == null) {
            do {
                next = parser.next();
    ...
    private int parseItem(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        int type;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme, attrs, C0010R.styleable.AnimatedStateListDrawableItem);
        int keyframeId = a.getResourceId(C0010R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        Drawable dr = null;
        int drawableId = a.getResourceId(C0010R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
        if (drawableId > 0) {
            dr = ResourceManagerInternal.get().getDrawable(context, drawableId);
        }
        a.recycle();
