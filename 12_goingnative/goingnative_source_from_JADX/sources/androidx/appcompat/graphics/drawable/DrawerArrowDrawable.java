...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes((AttributeSet) null, C0005R.styleable.DrawerArrowToggle, C0005R.attr.drawerArrowStyle, C0005R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0005R.styleable.DrawerArrowToggle_color, 0));
        setBarThickness(a.getDimension(C0005R.styleable.DrawerArrowToggle_thickness, 0.0f));
        setSpinEnabled(a.getBoolean(C0005R.styleable.DrawerArrowToggle_spinBars, true));
        setGapSize((float) Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_gapBetweenBars, 0.0f)));
        this.mSize = a.getDimensionPixelSize(C0005R.styleable.DrawerArrowToggle_drawableSize, 0);
        this.mBarLength = (float) Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_barLength, 0.0f));
        this.mArrowHeadLength = (float) Math.round(a.getDimension(C0005R.styleable.DrawerArrowToggle_arrowHeadLength, 0.0f));
        this.mArrowShaftLength = a.getDimension(C0005R.styleable.DrawerArrowToggle_arrowShaftLength, 0.0f);
        a.recycle();
    }
