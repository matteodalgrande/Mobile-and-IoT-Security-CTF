...
class GhostViewHolder extends FrameLayout {
    ...
    GhostViewHolder(ViewGroup parent) {
        ...
        this.mParent = parent;
        parent.setTag(C0068R.C0071id.ghost_view_holder, this);
    ...
    public void onViewRemoved(View child) {
        ...
        if ((getChildCount() == 1 && getChildAt(0) == child) || getChildCount() == 0) {
            this.mParent.setTag(C0068R.C0071id.ghost_view_holder, (Object) null);
    ...
    static GhostViewHolder getHolder(ViewGroup parent) {
        return (GhostViewHolder) parent.getTag(C0068R.C0071id.ghost_view_holder);
    }
