...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        View savedOverlayView = (View) startView.getTag(C0068R.C0071id.save_overlay_view);
        ...
        if (overlayView != null) {
            ...
            if (!reusingOverlayView) {
                if (animator == null) {
                    ...
                    startView.setTag(C0068R.C0071id.save_overlay_view, overlayView);
                    ...
                    addListener(new TransitionListenerAdapter() {
                        ...
                        public void onTransitionEnd(Transition transition) {
                            startView.setTag(C0068R.C0071id.save_overlay_view, (Object) null);
                            ViewGroupUtils.getOverlay(overlayHost).remove(finalOverlayView);
