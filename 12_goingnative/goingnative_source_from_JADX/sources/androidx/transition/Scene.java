...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup sceneRoot, int layoutId, Context context) {
        SparseArray<Scene> scenes = (SparseArray) sceneRoot.getTag(C0068R.C0071id.transition_scene_layoutid_cache);
        if (scenes == null) {
            scenes = new SparseArray<>();
            sceneRoot.setTag(C0068R.C0071id.transition_scene_layoutid_cache, scenes);
        }
    ...
    static void setCurrentScene(ViewGroup sceneRoot, Scene scene) {
        sceneRoot.setTag(C0068R.C0071id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup sceneRoot) {
        return (Scene) sceneRoot.getTag(C0068R.C0071id.transition_current_scene);
    }
