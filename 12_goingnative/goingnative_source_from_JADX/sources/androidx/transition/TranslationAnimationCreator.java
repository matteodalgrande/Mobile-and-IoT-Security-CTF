...
class TranslationAnimationCreator {
    static Animator createAnimation(View view, TransitionValues values, int viewPosX, int viewPosY, float startX, float startY, float endX, float endY, TimeInterpolator interpolator, Transition transition) {
        ...
        int[] startPosition = (int[]) transitionValues.view.getTag(C0068R.C0071id.transition_position);
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        TransitionPositionListener(View movingView, View viewInHierarchy, int startX, int startY, float terminalX, float terminalY) {
            ...
            int[] iArr = (int[]) viewInHierarchy.getTag(C0068R.C0071id.transition_position);
            this.mTransitionPosition = iArr;
            if (iArr != null) {
                viewInHierarchy.setTag(C0068R.C0071id.transition_position, (Object) null);
            }
        }
        ...
        public void onAnimationCancel(Animator animation) {
            ...
            this.mViewInHierarchy.setTag(C0068R.C0071id.transition_position, this.mTransitionPosition);
        }
