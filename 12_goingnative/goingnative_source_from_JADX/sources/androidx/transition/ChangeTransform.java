...
public class ChangeTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        if (view.getVisibility() != 8) {
            ...
            if (this.mReparent) {
                ...
                transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0068R.C0071id.transition_transform));
                transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0068R.C0071id.parent_matrix));
            }
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                if (!this.mIsCanceled) {
                    if (!z || !ChangeTransform.this.mUseOverlay) {
                        view2.setTag(C0068R.C0071id.transition_transform, (Object) null);
                        view2.setTag(C0068R.C0071id.parent_matrix, (Object) null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix currentMatrix) {
                ...
                view2.setTag(C0068R.C0071id.transition_transform, this.mTempMatrix);
                transforms.restore(view2);
            }
        };
    ...
    private void setMatricesForParent(TransitionValues startValues, TransitionValues endValues) {
        ...
        endValues.view.setTag(C0068R.C0071id.parent_matrix, endParentMatrix);
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.mView.setTag(C0068R.C0071id.transition_transform, (Object) null);
            this.mView.setTag(C0068R.C0071id.parent_matrix, (Object) null);
        }
