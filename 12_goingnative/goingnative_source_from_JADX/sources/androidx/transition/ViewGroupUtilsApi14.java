...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            C04371 r0 = new LayoutTransition() {
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0068R.C0071id.transition_layout_save, layoutTransition);
                }
            }
        ...
        LayoutTransition layoutTransition2 = (LayoutTransition) group.getTag(C0068R.C0071id.transition_layout_save);
        if (layoutTransition2 != null) {
            group.setTag(C0068R.C0071id.transition_layout_save, (Object) null);
