...
class ViewUtilsBase {
    ...
    public void setTransitionAlpha(View view, float alpha) {
        Float savedAlpha = (Float) view.getTag(C0068R.C0071id.save_non_transition_alpha);
        if (savedAlpha != null) {
    ...
    public void saveNonTransitionAlpha(View view) {
        if (view.getTag(C0068R.C0071id.save_non_transition_alpha) == null) {
            view.setTag(C0068R.C0071id.save_non_transition_alpha, Float.valueOf(view.getAlpha()));
        }
    }

    public void clearNonTransitionAlpha(View view) {
        if (view.getVisibility() == 0) {
            view.setTag(C0068R.C0071id.save_non_transition_alpha, (Object) null);
        }
    }
