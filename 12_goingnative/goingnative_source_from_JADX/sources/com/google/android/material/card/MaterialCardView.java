...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_CardView;
    private static final int[] DRAGGED_STATE_SET = {C0089R.attr.state_dragged};
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0089R.styleable.MaterialCardView
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            r3 = r10
