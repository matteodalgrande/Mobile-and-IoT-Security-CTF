...
class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView card, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray cardViewAttributes = card.getContext().obtainStyledAttributes(attrs, C0089R.styleable.CardView, defStyleAttr, C0089R.style.CardView);
        if (cardViewAttributes.hasValue(C0089R.styleable.CardView_cardCornerRadius)) {
            shapeAppearanceModelBuilder.setAllCornerSizes(cardViewAttributes.getDimension(C0089R.styleable.CardView_cardCornerRadius, 0.0f));
        }
    ...
    public void loadFromAttributes(TypedArray attributes) {
        ColorStateList colorStateList = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0089R.styleable.MaterialCardView_strokeColor);
        this.strokeColor = colorStateList;
        if (colorStateList == null) {
            this.strokeColor = ColorStateList.valueOf(-1);
        }
        this.strokeWidth = attributes.getDimensionPixelSize(C0089R.styleable.MaterialCardView_strokeWidth, 0);
        boolean z = attributes.getBoolean(C0089R.styleable.MaterialCardView_android_checkable, false);
        this.checkable = z;
        this.materialCardView.setLongClickable(z);
        this.checkedIconTint = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0089R.styleable.MaterialCardView_checkedIconTint);
        setCheckedIcon(MaterialResources.getDrawable(this.materialCardView.getContext(), attributes, C0089R.styleable.MaterialCardView_checkedIcon));
        setCheckedIconSize(attributes.getDimensionPixelSize(C0089R.styleable.MaterialCardView_checkedIconSize, 0));
        setCheckedIconMargin(attributes.getDimensionPixelSize(C0089R.styleable.MaterialCardView_checkedIconMargin, 0));
        ColorStateList colorStateList2 = MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0089R.styleable.MaterialCardView_rippleColor);
        this.rippleColor = colorStateList2;
        if (colorStateList2 == null) {
            this.rippleColor = ColorStateList.valueOf(MaterialColors.getColor(this.materialCardView, C0089R.attr.colorControlHighlight));
        }
        setCardForegroundColor(MaterialResources.getColorStateList(this.materialCardView.getContext(), attributes, C0089R.styleable.MaterialCardView_cardForegroundColor));
        updateRippleColor();
        updateElevation();
        updateStroke();
    ...
    public void setCheckedIcon(Drawable checkedIcon2) {
        ...
        if (this.clickableForegroundDrawable != null) {
            this.clickableForegroundDrawable.setDrawableByLayerId(C0089R.C0092id.mtrl_card_checked_layer_id, createCheckedIconLayer());
        }
    }
    ...
    private Drawable getClickableForeground() {
        ...
        if (this.clickableForegroundDrawable == null) {
            ...
            layerDrawable.setId(2, C0089R.C0092id.mtrl_card_checked_layer_id);
        }
