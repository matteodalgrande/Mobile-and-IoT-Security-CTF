...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    public static ChipDrawable createFromResource(Context context2, int id) {
        ...
        if (style == 0) {
            style = C0089R.style.Widget_MaterialComponents_Chip_Entry;
        }
        return createFromAttributes(context2, attrs, C0089R.attr.chipStandaloneStyle, style);
    }
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(this.context, attrs, C0089R.styleable.Chip, defStyleAttr, defStyleRes, new int[0]);
        this.isShapeThemingEnabled = a.hasValue(C0089R.styleable.Chip_shapeAppearance);
        setChipSurfaceColor(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_chipSurfaceColor));
        setChipBackgroundColor(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_chipBackgroundColor));
        setChipMinHeight(a.getDimension(C0089R.styleable.Chip_chipMinHeight, 0.0f));
        if (a.hasValue(C0089R.styleable.Chip_chipCornerRadius)) {
            setChipCornerRadius(a.getDimension(C0089R.styleable.Chip_chipCornerRadius, 0.0f));
        }
        setChipStrokeColor(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_chipStrokeColor));
        setChipStrokeWidth(a.getDimension(C0089R.styleable.Chip_chipStrokeWidth, 0.0f));
        setRippleColor(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_rippleColor));
        setText(a.getText(C0089R.styleable.Chip_android_text));
        TextAppearance textAppearance = MaterialResources.getTextAppearance(this.context, a, C0089R.styleable.Chip_android_textAppearance);
        textAppearance.textSize = a.getDimension(C0089R.styleable.Chip_android_textSize, textAppearance.textSize);
        setTextAppearance(textAppearance);
        int ellipsize = a.getInt(C0089R.styleable.Chip_android_ellipsize, 0);
        if (ellipsize == 1) {
        ...
        setChipIconVisible(a.getBoolean(C0089R.styleable.Chip_chipIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "chipIconVisible") != null)) {
            setChipIconVisible(a.getBoolean(C0089R.styleable.Chip_chipIconEnabled, false));
        }
        setChipIcon(MaterialResources.getDrawable(this.context, a, C0089R.styleable.Chip_chipIcon));
        if (a.hasValue(C0089R.styleable.Chip_chipIconTint)) {
            setChipIconTint(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_chipIconTint));
        }
        setChipIconSize(a.getDimension(C0089R.styleable.Chip_chipIconSize, -1.0f));
        setCloseIconVisible(a.getBoolean(C0089R.styleable.Chip_closeIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "closeIconVisible") != null)) {
            setCloseIconVisible(a.getBoolean(C0089R.styleable.Chip_closeIconEnabled, false));
        }
        setCloseIcon(MaterialResources.getDrawable(this.context, a, C0089R.styleable.Chip_closeIcon));
        setCloseIconTint(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_closeIconTint));
        setCloseIconSize(a.getDimension(C0089R.styleable.Chip_closeIconSize, 0.0f));
        setCheckable(a.getBoolean(C0089R.styleable.Chip_android_checkable, false));
        setCheckedIconVisible(a.getBoolean(C0089R.styleable.Chip_checkedIconVisible, false));
        if (!(attrs == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconEnabled") == null || attrs.getAttributeValue(NAMESPACE_APP, "checkedIconVisible") != null)) {
            setCheckedIconVisible(a.getBoolean(C0089R.styleable.Chip_checkedIconEnabled, false));
        }
        setCheckedIcon(MaterialResources.getDrawable(this.context, a, C0089R.styleable.Chip_checkedIcon));
        if (a.hasValue(C0089R.styleable.Chip_checkedIconTint)) {
            setCheckedIconTint(MaterialResources.getColorStateList(this.context, a, C0089R.styleable.Chip_checkedIconTint));
        }
        setShowMotionSpec(MotionSpec.createFromAttribute(this.context, a, C0089R.styleable.Chip_showMotionSpec));
        setHideMotionSpec(MotionSpec.createFromAttribute(this.context, a, C0089R.styleable.Chip_hideMotionSpec));
        setChipStartPadding(a.getDimension(C0089R.styleable.Chip_chipStartPadding, 0.0f));
        setIconStartPadding(a.getDimension(C0089R.styleable.Chip_iconStartPadding, 0.0f));
        setIconEndPadding(a.getDimension(C0089R.styleable.Chip_iconEndPadding, 0.0f));
        setTextStartPadding(a.getDimension(C0089R.styleable.Chip_textStartPadding, 0.0f));
        setTextEndPadding(a.getDimension(C0089R.styleable.Chip_textEndPadding, 0.0f));
        setCloseIconStartPadding(a.getDimension(C0089R.styleable.Chip_closeIconStartPadding, 0.0f));
        setCloseIconEndPadding(a.getDimension(C0089R.styleable.Chip_closeIconEndPadding, 0.0f));
        setChipEndPadding(a.getDimension(C0089R.styleable.Chip_chipEndPadding, 0.0f));
        setMaxWidth(a.getDimensionPixelSize(C0089R.styleable.Chip_android_maxWidth, ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
        a.recycle();
    }
