...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.chipStyle);
    }
    ...
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C0089R.styleable.Chip
            r0 = 0
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            ...
            int r1 = com.google.android.material.C0089R.styleable.Chip_android_textColor
            ...
            r7.setTextColor(r1)
        L_0x0052:
            int r1 = com.google.android.material.C0089R.styleable.Chip_shapeAppearance
    ...
    private void initMinTouchTarget(Context context, AttributeSet attrs, int defStyleAttr) {
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0089R.styleable.Chip, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = a.getBoolean(C0089R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil((double) a.getDimension(C0089R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) ViewUtils.dpToPx(getContext(), 48))));
        a.recycle();
    }
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            ...
            if (virtualViewId == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0089R.string.mtrl_chip_close_icon_content_description;
