...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0089R.styleable.RangeSlider, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (a.hasValue(C0089R.styleable.RangeSlider_values)) {
            setValues(convertToFloat(a.getResources().obtainTypedArray(a.getResourceId(C0089R.styleable.RangeSlider_values, 0))));
        }
        this.minSeparation = a.getDimension(C0089R.styleable.RangeSlider_minSeparation, 0.0f);
        a.recycle();
    }
