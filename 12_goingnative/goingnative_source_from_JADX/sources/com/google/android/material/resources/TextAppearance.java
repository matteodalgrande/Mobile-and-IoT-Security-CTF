...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int id) {
        TypedArray a = context.obtainStyledAttributes(id, C0089R.styleable.TextAppearance);
        this.textSize = a.getDimension(C0089R.styleable.TextAppearance_android_textSize, 0.0f);
        this.textColor = MaterialResources.getColorStateList(context, a, C0089R.styleable.TextAppearance_android_textColor);
        this.textColorHint = MaterialResources.getColorStateList(context, a, C0089R.styleable.TextAppearance_android_textColorHint);
        this.textColorLink = MaterialResources.getColorStateList(context, a, C0089R.styleable.TextAppearance_android_textColorLink);
        this.textStyle = a.getInt(C0089R.styleable.TextAppearance_android_textStyle, 0);
        this.typeface = a.getInt(C0089R.styleable.TextAppearance_android_typeface, 1);
        int fontFamilyIndex = MaterialResources.getIndexWithValue(a, C0089R.styleable.TextAppearance_fontFamily, C0089R.styleable.TextAppearance_android_fontFamily);
        this.fontFamilyResourceId = a.getResourceId(fontFamilyIndex, 0);
        this.fontFamily = a.getString(fontFamilyIndex);
        this.textAllCaps = a.getBoolean(C0089R.styleable.TextAppearance_textAllCaps, false);
        this.shadowColor = MaterialResources.getColorStateList(context, a, C0089R.styleable.TextAppearance_android_shadowColor);
        this.shadowDx = a.getFloat(C0089R.styleable.TextAppearance_android_shadowDx, 0.0f);
        this.shadowDy = a.getFloat(C0089R.styleable.TextAppearance_android_shadowDy, 0.0f);
        this.shadowRadius = a.getFloat(C0089R.styleable.TextAppearance_android_shadowRadius, 0.0f);
        a.recycle();
        if (Build.VERSION.SDK_INT >= 21) {
            TypedArray a2 = context.obtainStyledAttributes(id, C0089R.styleable.MaterialTextAppearance);
            this.hasLetterSpacing = a2.hasValue(C0089R.styleable.MaterialTextAppearance_android_letterSpacing);
            this.letterSpacing = a2.getFloat(C0089R.styleable.MaterialTextAppearance_android_letterSpacing, 0.0f);
            a2.recycle();
            return;
        }
