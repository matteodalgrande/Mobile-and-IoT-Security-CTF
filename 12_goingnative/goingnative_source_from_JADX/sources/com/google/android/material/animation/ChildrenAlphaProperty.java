...
public class ChildrenAlphaProperty extends Property<ViewGroup, Float> {
    ...
    public Float get(ViewGroup object) {
        Float alpha = (Float) object.getTag(C0089R.C0092id.mtrl_internal_children_alpha_tag);
        if (alpha != null) {
            return alpha;
        }
    ...
    public void set(ViewGroup object, Float value) {
        ...
        object.setTag(C0089R.C0092id.mtrl_internal_children_alpha_tag, Float.valueOf(alpha));
