...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0089R.styleable.ForegroundLinearLayout, defStyle, 0, new int[0]);
        this.foregroundGravity = a.getInt(C0089R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.foregroundGravity);
        Drawable d = a.getDrawable(C0089R.styleable.ForegroundLinearLayout_android_foreground);
        if (d != null) {
            setForeground(d);
        }
        this.mForegroundInPadding = a.getBoolean(C0089R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
        a.recycle();
    }
