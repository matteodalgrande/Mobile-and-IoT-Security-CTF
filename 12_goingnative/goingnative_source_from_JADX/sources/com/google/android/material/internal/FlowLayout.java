...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attrs) {
        TypedArray array = context.getTheme().obtainStyledAttributes(attrs, C0089R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = array.getDimensionPixelSize(C0089R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = array.getDimensionPixelSize(C0089R.styleable.FlowLayout_itemSpacing, 0);
        array.recycle();
    }
    ...
    public void onLayout(boolean sizeChanged, int left, int top, int right, int bottom) {
        ...
        while (i < getChildCount()) {
            ...
            if (child.getVisibility() == 8) {
                child.setTag(C0089R.C0092id.row_index_key, -1);
                ...
                paddingStart = paddingStart2;
                child.setTag(C0089R.C0092id.row_index_key, Integer.valueOf(this.rowCount - 1));
    ...
    public int getRowIndex(View child) {
        Object index = child.getTag(C0089R.C0092id.row_index_key);
