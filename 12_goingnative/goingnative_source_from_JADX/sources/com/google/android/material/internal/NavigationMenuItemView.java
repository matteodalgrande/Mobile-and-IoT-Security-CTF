...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        C05761 r0 = new AccessibilityDelegateCompat() {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0089R.layout.design_navigation_menu_item, this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C0089R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C0089R.C0092id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0089R.C0092id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable = ResourcesCompat.getDrawable(getResources(), C0089R.C0091drawable.navigation_empty_icon, getContext().getTheme());
