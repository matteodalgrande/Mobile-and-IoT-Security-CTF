...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    public void initForMenu(Context context, MenuBuilder menu2) {
        ...
        this.menu = menu2;
        this.paddingSeparator = context.getResources().getDimensionPixelOffset(C0089R.dimen.design_navigation_separator_vertical_padding);
    }

    public MenuView getMenuView(ViewGroup root) {
        if (this.menuView == null) {
            NavigationMenuView navigationMenuView = (NavigationMenuView) this.layoutInflater.inflate(C0089R.layout.design_navigation_menu, root, false);
            ...
            this.headerLayout = (LinearLayout) this.layoutInflater.inflate(C0089R.layout.design_navigation_item_header, this.menuView, false);
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater inflater, ViewGroup parent, View.OnClickListener listener) {
            super(inflater.inflate(C0089R.layout.design_navigation_item, parent, false));
    ...
    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(C0089R.layout.design_navigation_item_subheader, parent, false));
        }
    }

    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater inflater, ViewGroup parent) {
            super(inflater.inflate(C0089R.layout.design_navigation_item_separator, parent, false));
        }
    }
