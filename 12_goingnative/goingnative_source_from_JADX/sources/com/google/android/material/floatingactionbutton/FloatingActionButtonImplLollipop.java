...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public BorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0089R.C0090color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0089R.C0090color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0089R.C0090color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0089R.C0090color.design_fab_stroke_end_outer_color));
