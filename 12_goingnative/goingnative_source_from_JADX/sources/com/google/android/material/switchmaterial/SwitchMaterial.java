...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0089R.styleable.SwitchMaterial
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r1 = com.google.android.material.C0089R.styleable.SwitchMaterial_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            float thumbElevation = getResources().getDimension(C0089R.dimen.mtrl_switch_thumb_elevation);
