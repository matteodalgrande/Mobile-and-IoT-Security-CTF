...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    private static final int DEFAULT_STYLE = C0089R.style.Widget_MaterialComponents_Tooltip;
    private static final int DEFAULT_THEME_ATTR = C0089R.attr.tooltipStyle;
    ...
    private void loadFromAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(this.context, attrs, C0089R.styleable.Tooltip, defStyleAttr, defStyleRes, new int[0]);
        this.arrowSize = this.context.getResources().getDimensionPixelSize(C0089R.dimen.mtrl_tooltip_arrowSize);
        setShapeAppearanceModel(getShapeAppearanceModel().toBuilder().setBottomEdge(createMarkerEdge()).build());
        setText(a.getText(C0089R.styleable.Tooltip_android_text));
        setTextAppearance(MaterialResources.getTextAppearance(this.context, a, C0089R.styleable.Tooltip_android_textAppearance));
        setFillColor(ColorStateList.valueOf(a.getColor(C0089R.styleable.Tooltip_backgroundTint, MaterialColors.layer(ColorUtils.setAlphaComponent(MaterialColors.getColor(this.context, 16842801, cls.getCanonicalName()), 229), ColorUtils.setAlphaComponent(MaterialColors.getColor(this.context, C0089R.attr.colorOnBackground, cls.getCanonicalName()), 153)))));
        setStrokeColor(ColorStateList.valueOf(MaterialColors.getColor(this.context, C0089R.attr.colorSurface, cls.getCanonicalName())));
        this.padding = a.getDimensionPixelSize(C0089R.styleable.Tooltip_android_padding, 0);
        this.minWidth = a.getDimensionPixelSize(C0089R.styleable.Tooltip_android_minWidth, 0);
        this.minHeight = a.getDimensionPixelSize(C0089R.styleable.Tooltip_android_minHeight, 0);
        this.layoutMargin = a.getDimensionPixelSize(C0089R.styleable.Tooltip_android_layout_margin, 0);
        a.recycle();
    }
