...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(display.widthPixels, display.heightPixels) > res.getDimensionPixelSize(C0089R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis) ? C0089R.attr.materialCalendarTheme : C0089R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return res.getString(C0089R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return res.getString(C0089R.string.mtrl_picker_range_header_only_start_selected, new Object[]{DateStrings.getDateString(this.selectedStartItem.longValue())});
        } else if (l == null) {
            return res.getString(C0089R.string.mtrl_picker_range_header_only_end_selected, new Object[]{DateStrings.getDateString(this.selectedEndItem.longValue())});
        } else {
            Pair<String, String> dateRangeStrings = DateStrings.getDateRangeString(l, l2);
            return res.getString(C0089R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeStrings.first, dateRangeStrings.second});
        }
    }

    public int getDefaultTitleResId() {
        return C0089R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Pair<Long, Long>> listener) {
        View root = layoutInflater.inflate(C0089R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout startTextInput = (TextInputLayout) root.findViewById(C0089R.C0092id.mtrl_picker_text_input_range_start);
        TextInputLayout endTextInput = (TextInputLayout) root.findViewById(C0089R.C0092id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = root.getResources().getString(C0089R.string.mtrl_picker_invalid_range);
        ...
        C05501 r0 = new DateFormatTextWatcher(formatHint, format, startTextInput, calendarConstraints) {
