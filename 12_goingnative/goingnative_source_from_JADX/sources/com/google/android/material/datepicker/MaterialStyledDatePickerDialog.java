...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    private static final int DEF_STYLE_RES = C0089R.style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(Context context, int themeResId, DatePickerDialog.OnDateSetListener listener, int year, int monthOfYear, int dayOfMonth) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(getContext(), C0089R.attr.colorSurface, getClass().getCanonicalName());
        int i = DEF_STYLE_RES;
