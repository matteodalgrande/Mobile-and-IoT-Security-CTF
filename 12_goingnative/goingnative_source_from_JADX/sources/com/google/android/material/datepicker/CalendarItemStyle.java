...
final class CalendarItemStyle {
    ...
    static CalendarItemStyle create(Context context, int materialCalendarItemStyle) {
        ...
        TypedArray styleableArray = context2.obtainStyledAttributes(i, C0089R.styleable.MaterialCalendarItem);
        Rect insets2 = new Rect(styleableArray.getDimensionPixelOffset(C0089R.styleable.MaterialCalendarItem_android_insetLeft, 0), styleableArray.getDimensionPixelOffset(C0089R.styleable.MaterialCalendarItem_android_insetTop, 0), styleableArray.getDimensionPixelOffset(C0089R.styleable.MaterialCalendarItem_android_insetRight, 0), styleableArray.getDimensionPixelOffset(C0089R.styleable.MaterialCalendarItem_android_insetBottom, 0));
        ColorStateList backgroundColor2 = MaterialResources.getColorStateList(context2, styleableArray, C0089R.styleable.MaterialCalendarItem_itemFillColor);
        ColorStateList textColor2 = MaterialResources.getColorStateList(context2, styleableArray, C0089R.styleable.MaterialCalendarItem_itemTextColor);
        ColorStateList strokeColor2 = MaterialResources.getColorStateList(context2, styleableArray, C0089R.styleable.MaterialCalendarItem_itemStrokeColor);
        int strokeWidth2 = styleableArray.getDimensionPixelSize(C0089R.styleable.MaterialCalendarItem_itemStrokeWidth, 0);
        int shapeAppearanceResId = styleableArray.getResourceId(C0089R.styleable.MaterialCalendarItem_itemShapeAppearance, 0);
        ShapeAppearanceModel itemShape2 = ShapeAppearanceModel.builder(context2, shapeAppearanceResId, styleableArray.getResourceId(C0089R.styleable.MaterialCalendarItem_itemShapeAppearanceOverlay, 0)).build();
