...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(context, C0089R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, (AttributeSet) null, C0089R.attr.materialCalendarStyle, C0089R.style.Widget_MaterialComponents_MaterialCalendar);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View root = layoutInflater.inflate(this.fullscreen ? C0089R.layout.mtrl_picker_fullscreen : C0089R.layout.mtrl_picker_dialog, viewGroup);
        Context context = root.getContext();
        if (this.fullscreen) {
            root.findViewById(C0089R.C0092id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View pane = root.findViewById(C0089R.C0092id.mtrl_calendar_main_pane);
            View frame = root.findViewById(C0089R.C0092id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) root.findViewById(C0089R.C0092id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) root.findViewById(C0089R.C0092id.mtrl_picker_header_toggle);
        TextView titleTextView = (TextView) root.findViewById(C0089R.C0092id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) root.findViewById(C0089R.C0092id.confirm_button);
        ...
        Button cancelButton = (Button) root.findViewById(C0089R.C0092id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int inset = getResources().getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C0089R.string.mtrl_picker_announce_current_selection), new Object[]{headerText}));
    ...
    public void startPickerFragment() {
        ...
        fragmentTransaction.replace(C0089R.C0092id.mtrl_calendar_frame, this.pickerFragment);
    ...
    public void updateToggleContentDescription(CheckableImageButton toggle) {
        ...
        if (this.headerToggleButton.isChecked()) {
            contentDescription = toggle.getContext().getString(C0089R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            contentDescription = toggle.getContext().getString(C0089R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        toggleDrawable.addState(new int[]{16842912}, AppCompatResources.getDrawable(context, C0089R.C0091drawable.material_ic_calendar_black_24dp));
        toggleDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C0089R.C0091drawable.material_ic_edit_black_24dp));
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C0089R.attr.nestedScrollable);
    }

    static boolean readMaterialCalendarStyleBoolean(Context context, int attributeResId) {
        TypedArray a = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C0089R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{attributeResId});
    ...
    private static int getDialogPickerHeight(Context context) {
        ...
        int navigationHeight = resources.getDimensionPixelSize(C0089R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_navigation_bottom_padding);
        int daysOfWeekHeight = resources.getDimensionPixelSize(C0089R.dimen.mtrl_calendar_days_of_week_height);
        return navigationHeight + daysOfWeekHeight + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C0089R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_bottom_padding);
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int padding = resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_content_padding);
        int daysInWeek = Month.current().daysInWeek;
        return (padding * 2) + (daysInWeek * resources.getDimensionPixelSize(C0089R.dimen.mtrl_calendar_day_width)) + ((daysInWeek - 1) * resources.getDimensionPixelOffset(C0089R.dimen.mtrl_calendar_month_horizontal_padding));
    }
