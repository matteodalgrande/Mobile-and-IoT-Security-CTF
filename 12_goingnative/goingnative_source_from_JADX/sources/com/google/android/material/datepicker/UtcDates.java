...
class UtcDates {
    ...
    static String getTextInputHint(Resources res, SimpleDateFormat format) {
        ...
        return formatHint.replaceAll("d", res.getString(C0089R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", res.getString(C0089R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", res.getString(C0089R.string.mtrl_picker_text_input_year_abbr));
    }
