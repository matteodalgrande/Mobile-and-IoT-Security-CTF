...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (MaterialDatePicker.isFullscreen(themedContext)) {
            layout = C0089R.layout.mtrl_calendar_vertical;
            orientation = 1;
        } else {
            layout = C0089R.layout.mtrl_calendar_horizontal;
            orientation = 0;
        }
        View root = themedInflater.inflate(layout, viewGroup, false);
        GridView daysHeader = (GridView) root.findViewById(C0089R.C0092id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) root.findViewById(C0089R.C0092id.mtrl_calendar_months);
        ...
        int columns = themedContext.getResources().getInteger(C0089R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView2 = (RecyclerView) root.findViewById(C0089R.C0092id.mtrl_calendar_year_selector_frame);
        ...
        if (root.findViewById(C0089R.C0092id.month_navigation_fragment_toggle) != null) {
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C0089R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View root, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton monthDropSelect = (MaterialButton) root.findViewById(C0089R.C0092id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(monthDropSelect, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    str = MaterialCalendar.this.getString(C0089R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    str = MaterialCalendar.this.getString(C0089R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(str);
            }
        });
        MaterialButton monthPrev = (MaterialButton) root.findViewById(C0089R.C0092id.month_navigation_previous);
        monthPrev.setTag(NAVIGATION_PREV_TAG);
        MaterialButton monthNext = (MaterialButton) root.findViewById(C0089R.C0092id.month_navigation_next);
        monthNext.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = root.findViewById(C0089R.C0092id.mtrl_calendar_year_selector_frame);
        this.dayFrame = root.findViewById(C0089R.C0092id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
