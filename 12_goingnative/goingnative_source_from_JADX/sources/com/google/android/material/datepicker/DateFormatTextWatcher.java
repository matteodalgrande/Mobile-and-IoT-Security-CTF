...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    DateFormatTextWatcher(final String formatHint, DateFormat dateFormat2, TextInputLayout textInputLayout2, CalendarConstraints constraints2) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C0089R.string.mtrl_picker_out_of_range);
        this.setErrorCallback = new Runnable() {
            public void run() {
                ...
                String invalidFormat = context.getString(C0089R.string.mtrl_picker_invalid_format);
                String useLine = String.format(context.getString(C0089R.string.mtrl_picker_invalid_format_use), new Object[]{formatHint});
                textLayout.setError(invalidFormat + "\n" + useLine + "\n" + String.format(context.getString(C0089R.string.mtrl_picker_invalid_format_example), new Object[]{df.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))}));
