...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View viewOverride, int viewIdOverride, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        } else if (transitionValues.view.getTag(C0089R.C0092id.mtrl_motion_snapshot_view) instanceof View) {
            transitionValues.view.setTag(C0089R.C0092id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) transitionValues.view.getTag(C0089R.C0092id.mtrl_motion_snapshot_view);
        }
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModelOverride) {
        ...
        if (view.getTag(C0089R.C0092id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C0089R.C0092id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray a = context.obtainStyledAttributes(new int[]{C0089R.attr.transitionShapeAppearance});
