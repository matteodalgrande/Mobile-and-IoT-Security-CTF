...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C0089R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C0089R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C0089R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int overrideThemeResId) {
        ...
        int surfaceColor = MaterialColors.getColor(context2, C0089R.attr.colorSurface, getClass().getCanonicalName());
