...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Chip chip2 = (Chip) inflater.inflate(C0089R.layout.material_time_chip, this, false);
        this.chip = chip2;
        TextInputLayout textInputLayout2 = (TextInputLayout) inflater.inflate(C0089R.layout.material_time_input, this, false);
        ...
        this.label = (TextView) findViewById(C0089R.C0092id.material_label);
