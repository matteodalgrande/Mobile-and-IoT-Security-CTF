...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.materialClockStyle);
    }
    ...
    public ClockFaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0089R.styleable.ClockFaceView, defStyleAttr, C0089R.style.Widget_MaterialComponents_TimePicker_Clock);
        Resources res = getResources();
        ColorStateList colorStateList = MaterialResources.getColorStateList(context, a, C0089R.styleable.ClockFaceView_clockNumberTextColor);
        this.textColor = colorStateList;
        LayoutInflater.from(context).inflate(C0089R.layout.material_clockface_view, this, true);
        ClockHandView clockHandView2 = (ClockHandView) findViewById(C0089R.C0092id.material_clock_hand);
        this.clockHandView = clockHandView2;
        this.clockHandPadding = res.getDimensionPixelSize(C0089R.dimen.material_clock_hand_padding);
        ...
        int defaultBackgroundColor = AppCompatResources.getColorStateList(context, C0089R.C0090color.material_timepicker_clockface).getDefaultColor();
        ColorStateList backgroundColor = MaterialResources.getColorStateList(context, a, C0089R.styleable.ClockFaceView_clockFaceBackgroundColor);
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
                ...
                int index = ((Integer) host.getTag(C0089R.C0092id.material_value_index)).intValue();
                if (index > 0) {
    ...
    private void updateTextViews(int r9) {
        ...
        L_0x002e:
            ...
            int r5 = com.google.android.material.C0089R.layout.material_clockface_textview
        ...
        L_0x0042:
            ...
            r5 = r5[r2]
            r3.setText(r5)
            int r5 = com.google.android.material.C0089R.C0092id.material_value_index
