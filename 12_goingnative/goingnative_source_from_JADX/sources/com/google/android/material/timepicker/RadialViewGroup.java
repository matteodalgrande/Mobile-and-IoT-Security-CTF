...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C0089R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray a = context.obtainStyledAttributes(attrs, C0089R.styleable.RadialViewGroup, defStyleAttr, 0);
        this.radius = a.getDimensionPixelSize(C0089R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    public void updateLayoutParams() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childAt.getId() != C0089R.C0092id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0089R.C0092id.circle_center, this.radius, currentAngle);
