...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.selectionListener = new View.OnClickListener() {
            public void onClick(View v) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) v.getTag(C0089R.C0092id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C0089R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C0089R.C0092id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C0089R.C0092id.material_clock_period_toggle);
        this.toggle = materialButtonToggleGroup;
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() {
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                int period = checkedId == C0089R.C0092id.material_clock_period_pm_button ? 1 : 0;
        ...
        this.minuteView = (Chip) findViewById(C0089R.C0092id.material_minute_tv);
        this.hourView = (Chip) findViewById(C0089R.C0092id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C0089R.C0092id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C0089R.C0092id.selection_type, 12);
        this.hourView.setTag(C0089R.C0092id.selection_type, 10);
    ...
    public void updateTime(int period, int hourOfDay, int minute) {
        this.toggle.check(period == 1 ? C0089R.C0092id.material_clock_period_pm_button : C0089R.C0092id.material_clock_period_am_button);
    ...
    private void updateToggleConstraints() {
        if (this.toggle.getVisibility() == 0) {
            ...
            constraintSet.clear(C0089R.C0092id.material_clock_display, sideToClear);
