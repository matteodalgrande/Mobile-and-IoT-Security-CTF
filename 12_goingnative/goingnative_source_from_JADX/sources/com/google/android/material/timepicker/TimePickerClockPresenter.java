...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    public void setSelection(int selection, boolean animate) {
        ...
        timePickerView2.setValues(strArr, isMinute ? C0089R.string.material_minute_suffix : C0089R.string.material_hour_suffix);
        ...
        this.timePickerView.setMinuteHourDelegate(new ClickActionDelegate(this.timePickerView.getContext(), C0089R.string.material_hour_selection));
        this.timePickerView.setHourClickDelegate(new ClickActionDelegate(this.timePickerView.getContext(), C0089R.string.material_minute_selection));
    }
