...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C0089R.C0091drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0089R.string.password_toggle_content_description));
