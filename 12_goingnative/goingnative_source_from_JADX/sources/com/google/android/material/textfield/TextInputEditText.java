...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.editTextStyle);
    }
    ...
    public TextInputEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0089R.styleable.TextInputEditText, defStyleAttr, C0089R.style.Widget_Design_TextInputEditText, new int[0]);
        setTextInputLayoutFocusedRectEnabled(attributes.getBoolean(C0089R.styleable.TextInputEditText_textInputLayoutFocusedRectEnabled, false));
        attributes.recycle();
    }
    ...
    public boolean requestRectangleOnScreen(Rect rectangle) {
        ...
        if (textInputLayout != null && this.textInputLayoutFocusedRectEnabled) {
            this.parentRect.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(C0089R.dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout layout) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            setLabelFor(C0089R.C0092id.textinput_helper_text);
        }
        String str = "";
