...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        float popupCornerRadius = (float) this.context.getResources().getDimensionPixelOffset(C0089R.dimen.mtrl_shape_corner_size_small_component);
        float exposedDropdownPopupElevation = (float) this.context.getResources().getDimensionPixelOffset(C0089R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int exposedDropdownPopupVerticalPadding = this.context.getResources().getDimensionPixelOffset(C0089R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, IS_LOLLIPOP ? C0089R.C0091drawable.mtrl_dropdown_arrow : C0089R.C0091drawable.mtrl_ic_arrow_drop_down));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0089R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView editText) {
        if (!isEditable(editText)) {
            ...
            int rippleColor = MaterialColors.getColor(editText, C0089R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView editText, int rippleColor, int[][] states, MaterialShapeDrawable boxBackground) {
        ...
        int surfaceColor = MaterialColors.getColor(editText, C0089R.attr.colorSurface);
