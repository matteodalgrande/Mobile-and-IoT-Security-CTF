...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0089R.attr.autoCompleteTextViewStyle);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0089R.styleable.MaterialAutoCompleteTextView, defStyleAttr, C0089R.style.Widget_AppCompat_AutoCompleteTextView, new int[0]);
        if (attributes.hasValue(C0089R.styleable.MaterialAutoCompleteTextView_android_inputType) && attributes.getInt(C0089R.styleable.MaterialAutoCompleteTextView_android_inputType, 0) == 0) {
