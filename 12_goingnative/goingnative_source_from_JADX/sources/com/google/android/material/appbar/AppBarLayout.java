...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C0089R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L_0x0027:
            int[] r2 = com.google.android.material.C0089R.styleable.AppBarLayout
            int[] r5 = new int[r7]
            r0 = r10
            r1 = r11
            r3 = r12
            android.content.res.TypedArray r0 = com.google.android.material.internal.ThemeEnforcement.obtainStyledAttributes(r0, r1, r2, r3, r4, r5)
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_android_background
        ...
        L_0x005f:
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_expanded
        ...
        L_0x0070:
            ...
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_elevation
            boolean r1 = r0.hasValue(r1)
        ...
        L_0x0086:
            ...
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_android_keyboardNavigationCluster
            boolean r1 = r0.hasValue(r1)
        ...
        L_0x009d:
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_android_touchscreenBlocksFocus
            boolean r1 = r0.hasValue(r1)
        ...
        L_0x00ae:
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_liftOnScroll
            boolean r1 = r0.getBoolean(r1, r7)
            r9.liftOnScroll = r1
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_liftOnScrollTargetViewId
            int r1 = r0.getResourceId(r1, r6)
            r9.liftOnScrollTargetViewId = r1
            int r1 = com.google.android.material.C0089R.styleable.AppBarLayout_statusBarForeground
            android.graphics.drawable.Drawable r1 = r0.getDrawable(r1)
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C0089R.attr.state_liftable : -C0089R.attr.state_liftable;
        extraStates[1] = (!this.liftable || !this.lifted) ? -C0089R.attr.state_lifted : C0089R.attr.state_lifted;
        extraStates[2] = this.liftable ? C0089R.attr.state_collapsible : -C0089R.attr.state_collapsible;
        extraStates[3] = (!this.liftable || !this.lifted) ? -C0089R.attr.state_collapsed : C0089R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted2) {
        float appBarElevation = getResources().getDimension(C0089R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration((long) getResources().getInteger(C0089R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0089R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C0089R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C0089R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(c, a.getResourceId(C0089R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0089R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C0089R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
