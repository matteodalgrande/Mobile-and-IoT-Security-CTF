    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            if (header != null) {
                ...
                parent.onMeasureChild(child, parentWidthMeasureSpec, widthUsed, View.MeasureSpec.makeMeasureSpec(height, childLpHeight == -1 ? BasicMeasure.EXACTLY : Integer.MIN_VALUE), heightUsed);
                return true;
            }
            View view2 = child;
            return false;
