...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0089R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C0089R.attr.snackbarButtonStyle, C0089R.attr.snackbarTextViewStyle};
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            ...
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C0089R.layout.mtrl_layout_snackbar_include : C0089R.layout.design_layout_snackbar_include, parent, false);
