...
public final class CircularProgressIndicator extends BaseProgressIndicator<CircularProgressIndicatorSpec> {
    public static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_CircularProgressIndicator;
    ...
    public void setIndicatorSize(int indicatorSize) {
        if (((CircularProgressIndicatorSpec) this.spec).indicatorSize != indicatorSize) {
