...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_ProgressIndicator;
    ...
    protected BaseProgressIndicator(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C0089R.styleable.BaseProgressIndicator, defStyleAttr, defStyleRes, new int[0]);
        this.showDelay = a.getInt(C0089R.styleable.BaseProgressIndicator_showDelay, -1);
        this.minHideDelay = Math.min(a.getInt(C0089R.styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
        a.recycle();
    ...
    public void setIndicatorColor(int... indicatorColors) {
        if (indicatorColors.length == 0) {
            indicatorColors = new int[]{MaterialColors.getColor(getContext(), C0089R.attr.colorPrimary, -1)};
        }
