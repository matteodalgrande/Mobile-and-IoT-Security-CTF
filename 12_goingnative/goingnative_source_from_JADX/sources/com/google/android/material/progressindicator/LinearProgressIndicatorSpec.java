...
public final class LinearProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.linearProgressIndicatorStyle);
    }
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        boolean z = false;
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0089R.styleable.LinearProgressIndicator, C0089R.attr.linearProgressIndicatorStyle, LinearProgressIndicator.DEF_STYLE_RES, new int[0]);
        this.indeterminateAnimationType = a.getInt(C0089R.styleable.LinearProgressIndicator_indeterminateAnimationType, 1);
        this.indicatorDirection = a.getInt(C0089R.styleable.LinearProgressIndicator_indicatorDirectionLinear, 0);
        a.recycle();
        validateSpec();
