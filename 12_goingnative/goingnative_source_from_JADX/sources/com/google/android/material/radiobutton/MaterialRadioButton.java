...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C0089R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C0089R.attr.radioButtonStyle);
    }
    ...
    public MaterialRadioButton(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C0089R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r1 = com.google.android.material.C0089R.styleable.MaterialRadioButton_buttonTint
        ...
        L_0x002a:
            int r1 = com.google.android.material.C0089R.styleable.MaterialRadioButton_useMaterialThemeColors
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int colorControlActivated = MaterialColors.getColor(this, C0089R.attr.colorControlActivated);
            int colorOnSurface = MaterialColors.getColor(this, C0089R.attr.colorOnSurface);
            int colorSurface = MaterialColors.getColor(this, C0089R.attr.colorSurface);
